...
using SFA.DAS.WebTemplateSourceName.Web.ModelBinders;
using SFA.DAS.WebTemplateSourceName.Web.StartupExtensions;
...
namespace SFA.DAS.WebTemplateSourceName.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var config = Configuration.GetSection<WebTemplateSourceNameWeb>();
