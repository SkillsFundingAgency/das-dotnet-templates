...
using SFA.DAS.WebTemplateSourceName.Extensions;
...
namespace SFA.DAS.WebTemplateSourceName.Api.StartupExtensions
{
    ...
    {
        private const string EndpointName = "SFA.DAS.WebTemplateSourceName.Api";

        public static void StartNServiceBus(this UpdateableServiceProvider serviceProvider, WebTemplateSourceNameApi configuration, IWebHostEnvironment environment)
        {
