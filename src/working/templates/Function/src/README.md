...
```json
{
  ...
  "Values": {
    ...
    "ConfigNames": "SFA.DAS.WebTemplateSourceName.Functions",
...
Row Key: SFA.DAS.WebTemplateSourceName_1.0
...
```json
{  
  "WebTemplateSourceNameApiConfiguration":{
    "ApiBaseUrl": "",
    "SubscriptionKey": "",
    "ApiVersion": ""
  },
  "WebTemplateSourceNameFunctions":{
